...
#include "NewSweepSortCommon.hlsl"
...
RWStructuredBuffer<uint> b_index;      //buffer used to atomically assign partition tile indexes
...
void SweepScan(uint3 gtid : SV_GroupThreadID, uint3 gid : SV_GroupID)
{
