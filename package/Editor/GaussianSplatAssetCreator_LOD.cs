...
{
    public partial class GaussianSplatAssetCreator
    {
        [BurstCompile]
        struct ReorderMortonJobWith : IJobParallelFor
        {
            const float kScaler = (float) ((1 << 21) - 1);
            public float3 m_BoundsMin;
            public float3 m_InvBoundsSize;
            [ReadOnly] public NativeArray<InputSplatDataWithLOD> m_SplatData;
        ...
        static void ReorderMorton(NativeArray<InputSplatDataWithLOD> splatData, float3 boundsMin, float3 boundsMax)
        {
            ReorderMortonJobWith order = new ReorderMortonJobWith
            {
            ...
            NativeArray<InputSplatDataWithLOD> copy = new(order.m_SplatData, Allocator.TempJob);
        ...
        [BurstCompile]
        struct CalcBoundsJobWithLOD : IJob
        {
        ...
        [BurstCompile]
        static unsafe void GatherSHs(int splatCount, InputSplatDataWithLOD* splatData, float* shData)
        {
        ...
        static unsafe void ClusterSHs(NativeArray<InputSplatDataWithLOD> splatData, GaussianSplatAsset.SHFormat format, out NativeArray<GaussianSplatAsset.SHTableItemFloat16> shs, out NativeArray<int> shIndices)
        {
            shs = default;
            shIndices = default;
            ...
            GatherSHs(splatData.Length, (InputSplatDataWithLOD*) splatData.GetUnsafeReadOnlyPtr(), (float*) shData.GetUnsafePtr());
        ...
        [BurstCompile]
        struct CalcChunkDataJobWithLOD : IJobParallelFor
        {
            [NativeDisableParallelForRestriction] public NativeArray<InputSplatDataWithLOD> splatData;
            ...
            public void Execute(int chunkIdx)
            {
                ...
                {
                    InputSplatDataWithLOD s = splatData[i];
        ...
        static void CreateChunkData(NativeArray<InputSplatDataWithLOD> splatData, string filePath, ref Hash128 dataHash)
        {
            int chunkCount = (splatData.Length + GaussianSplatAsset.kChunkSize - 1) / GaussianSplatAsset.kChunkSize;
            CalcChunkDataJobWithLOD job = new CalcChunkDataJobWithLOD
            {
                splatData = splatData,
        ...
        [BurstCompile]
        struct CreatePositionsDataJobWithLOD : IJobParallelFor
        {
        ...
        void CreatePositionsData(NativeArray<InputSplatDataWithLOD> inputSplats, string filePath, ref Hash128 dataHash)
        {
            ...
            CreatePositionsDataJobWithLOD job = new CreatePositionsDataJobWithLOD
            {
                m_Input = inputSplats,
        ...
        [BurstCompile]
        struct CreateOtherDataJobWithLOD : IJobParallelFor
        {
            [ReadOnly] public NativeArray<InputSplatDataWithLOD> m_Input;
        ...
        void CreateOtherData(NativeArray<InputSplatDataWithLOD> inputSplats, string filePath, ref Hash128 dataHash, NativeArray<int> splatSHIndices)
        {
            ...
            CreateOtherDataJobWithLOD job = new CreateOtherDataJobWithLOD
            {
                m_Input = inputSplats,
        ...
        [BurstCompile]
        struct CreateColorDataJobWithLOD : IJobParallelFor
        {
            [ReadOnly] public NativeArray<InputSplatDataWithLOD> m_Input;
        ...
        void CreateColorData(NativeArray<InputSplatDataWithLOD> inputSplats, string filePath, ref Hash128 dataHash)
        {
            ...
            CreateColorDataJobWithLOD job = new CreateColorDataJobWithLOD();
        ...
        [BurstCompile]
        struct CreateSHDataJobWithLOD : IJobParallelFor
        {
            [ReadOnly] public NativeArray<InputSplatDataWithLOD> m_Input;
        ...
        void CreateSHData(NativeArray<InputSplatDataWithLOD> inputSplats, string filePath, ref Hash128 dataHash, NativeArray<GaussianSplatAsset.SHTableItemFloat16> clusteredSHs)
        {
            ...
            else
            {
                ...
                NativeArray<byte> data = new(dataLen, Allocator.TempJob);
                CreateSHDataJobWithLOD job = new CreateSHDataJobWithLOD
                {
                    m_Input = inputSplats,
                    m_Format = m_FormatSH,
                    m_Output = data
        ...
        [BurstCompile]
        struct CreateLODDataJobWithLOD : IJobParallelFor
        {
            [ReadOnly] public NativeArray<InputSplatDataWithLOD> m_Input;
            [NativeDisableParallelForRestriction] public NativeArray<byte> m_Output;
        ...
        unsafe void CreateLODAsset()
        {
            ...
            using NativeArray<InputSplatDataWithLOD> inputSplats = LoadInputSplatFileWithLOD(m_InputFile);
            ...
            var boundsJob = new CalcBoundsJobWithLOD
            {
                m_BoundsMin = &boundsMin,
                m_BoundsMax = &boundsMax,
            ...
            asset.Initialize(inputSplats.Length, m_FormatPos, m_FormatScale, m_FormatColor, m_FormatSH, boundsMin, boundsMax, cameras, true);
            asset.name = baseName;
